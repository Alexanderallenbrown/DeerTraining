...
for ind in range(0,5):
    ...
    xDeerPred1s.append(xDeerPred0[ind1])
    xDeerPred2s.append(xDeerPred2[ind1])
    xDeerPred3s.append(xDeerPred4[ind1])
    xDeerPred4s.append(xDeerPred6[ind1])
    xDeerPred5s.append(xDeerPred8[ind1])
    yDeerPred1s.append(yDeerPred0[ind1])
    yDeerPred2s.append(yDeerPred2[ind1])
    yDeerPred3s.append(yDeerPred4[ind1])
    yDeerPred4s.append(yDeerPred6[ind1])
    yDeerPred5s.append(yDeerPred8[ind1])
